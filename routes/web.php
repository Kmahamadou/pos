...
Route::get('/pos/invoice', 'PosController@InvoiceShow')->name('invoice.show');
Route::get('/pos/invoices', 'PosController@InvoiceList')->name('invoice.list');
Route::get('/pos/history', 'PosController@InvoiceHistory')->name('invoice.history');
// Route::get('historique', 'InvoicesController@index')->name('historique.index');
// Route::get('historique/{id}', 'InvoicesController@facture')->name('historique.facture');