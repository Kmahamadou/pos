...
<head>
    ...
    <title>ikaBoutiki | @yield('title')</title>
    <!-- Favicon-->
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('home')}}" style="text-transform: uppercase">ikaBoutiki - {{$user->business_name}} </a>
                        ...
                        <li class="body">
                           ...
                           {{--      <li>
                                    <a href="{{route('showuserprofile', $user->id)}}">
                                        ...
                                        <div class="menu-info">
                                            <h4 class="font-bold col-blue-grey">Modifier le Profile</h4>
                                        </div>
                                    </a>
                                </li> --}}
                                <li>
                                    <a href="{{route('logout')}}" onclick="event.preventDefault();
                                        ...
                                        <div class="menu-info">
                                            <h4 class="font-bold col-blue-grey">Deconexion</h4>
                                        </div>
