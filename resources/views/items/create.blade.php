...
@section('head')
    ...
    {{--<link rel="stylesheet" type="text/css" href="{{asset('inpos/css/demo.css')}}" />--}}
                ...
                <div class="body">
                    ...
                    <form action="{{route('item.store')}}" method="post" enctype="multipart/form-data">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-8">
                                <p>
                                    <b>Selectionner Categorie</b><a class="m-l-10 btn btn-success" href="{{route('category.create')}}">Ajouter Categorie</a>
                                </p>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="image">
                                            <img id="blah" class="img-responsive" src="{{asset('images/items/no_image.png')}}" width="300" height="300" alt="" >
                                        </div>
                                    </div>
                                </div>
                            </div>
