                    ...
                    <div class="carts">
                        <div id="tblDiv">
                            ...
                            <div class="m-b-10 m-r-10 p-t-10 clearfix" style="display: block;">
                                <a href="javascript:void(0);" id="delallcart" class="btn btn-danger m-r-10">Annuler</a>
                                <a href="javascript:void(0);" id="paymentbtn" class="btn btn-success">Paiement</a>
                            </div>
                            @else
                                <p>Selectionner produit </p>
                            @endif
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card clearfix">
                                    <div class="itemwrapper text-center">
                                        <div id="itemSingle">
                                            ...
                                            <p class="price">Prix: {{$item->retail_price}} Disponile (<span id="stock" class="quantity">{{$item->quantity}}</span>)</p>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 text-center" style="margin-bottom: 10px;">
                                                    <a class="btn bg-teal" id="addToCartBtn">Ajouter</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
